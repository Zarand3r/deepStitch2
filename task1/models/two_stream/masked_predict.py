...
def show_saliency_maps(args):
    model = salient_classifier.FusionModel.load_from_checkpoint(checkpoint_path=args.checkpoint_path)
    ...
    for idx in range(20, 260, 20):
        ...
        plt.savefig(f"saliency_figures/masked/rgb{idx}.png")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default=f'{settings1.checkpoints}/two_stream/AC_CE_EF_FG/_ckpt_epoch_30.ckpt')
