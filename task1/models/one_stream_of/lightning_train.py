...
if __name__ == '__main__':
	...
	checkpoint_callback = ModelCheckpoint(
		...
		filepath=os.path.join(settings.checkpoints1, "one_stream_of", classification_name, f'{hparams.arch}_{hparams.trainable_base}_{hparams.rnn_model}{hparams.masked}'),
		save_top_k=3,
		verbose=True,
		monitor='val_acc',
		mode='max',
