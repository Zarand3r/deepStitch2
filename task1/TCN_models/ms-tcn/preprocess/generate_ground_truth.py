...
def generate_labels(video_directory, output_directory, labels):
        ...
        for index, row in labels.iterrows():
                ...
                crop_intervals[fname] = [previous_start, previous_end]
...
if __name__ == '__main__':
        ...
        generate_labels("/mnt/md1/richard_bao/balint_data/classification_data/TCN/features","/mnt/md1/richard_bao/balint_data/classification_data/TCN/groundTruth",labels)
