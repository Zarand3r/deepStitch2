...
if __name__ == '__main__':
	...
	parser.add_argument('--fc-size', default=32, type=int, help='size of fully connected layer before rnn')
	...
	kwargs = {'gpus': [hparams.gpu], 'logger':logger, 'check_val_every_n_epoch':3, 
