...
parser.add_argument('--input_dir', default="/mnt/md1/richard_bao/tubes_data2/classification_data/FG",type=str, help='directory with the mp4 videos')
parser.add_argument('--gpu_id', default=2,type=int, help='which gpu')
