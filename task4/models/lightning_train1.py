...
class CustomDataset(Dataset):
        """CustomDataset"""
        def __init__(self, global_dir, kinematics_dir, kinematics_features, idxs= None, include_classes = [], flow_method = 'flownet', balance_classes = False, mode = 'train', max_frames = 150, stride = 2, masked="", upsample=False):
                ...
                if 'conv' not in self.hparams.rnn_model:
                        ...
                        for kk in range(nFrames):
                                ...
                                if kk == 0:
                                        ...
                                        outputs = outputs.reshape(1, 128, 6, 6)
...
if __name__ == '__main__':
        ...
        checkpoint_callback = ModelCheckpoint(
                ...
                filepath=os.path.join(settings.checkpoints4, "two_stream", classification_name, f'{hparams.arch}_{hparams.trainable_base}_{hparams.rnn_model}{hparams.masked}'),
                save_top_k=3,
                verbose=True,
                monitor='val_acc',
                mode='max',
        ...
        #PATH = "/home/idris/robosurgery/deepStitch2/task3/models/checkpoint.pth"
        #model.load_from_checkpoint(checkpoint_path=PATH, strict=False)
